...
from a file. A sample implementation is provided in the library named CryptoFeatureProvider which decrypts encrypted 
values in the properties based on a placeholder prefix.
...
The following snippet shows how to include RsaCrytoFeatureProvider in your spring config.
    ...
    <beaxns xmlns="http://www.springframework.org/schema/beans" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
        ...
        <bean class="org.polyglotted.attributerepo.features.RsaCryptoFeatureProvider">
...
To include AesCrytoFeatureProvider in your spring config.
    ...
    <beaxns xmlns="http://www.springframework.org/schema/beans" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
        ...
        <bean class="org.polyglotted.attributerepo.features.AesCryptoFeatureProvider">
            <constructor-arg ref="attributerepo.featureRegistry" />
